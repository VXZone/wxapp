...
vjs.Slider.prototype.update = function(){
  ...
  // If there is a handle, we need to acommentCount for the handle in our calculation for progress bar
  ...
  if (handle) {
    ...
    // The bar does reach the left side, so we need to acommentCount for this in the bar's width
