          ...
          <div class="panel-body">
            <form action="." method="post" class="form-horizontal text-left" role="form">
              ...
              <div class="form-group ${username!=null?'has-error':''}">
                ...
                <div class="col-sm-6">
                  <input class="form-control" type="text" name="username" value="${user.username}" ${user!=null?'readonly':''} />
               ...
               <div class="form-group ${username!=null?'has-error':''}">
                 <label class="col-sm-3" for="username">真实名称</label>
                 <div class="col-sm-6">
                    <input class="form-control" autocomplete="off" type="text" name="username" value="${user.username}" />
                     <p class="help-block">${username}</p>
                  </div>
               </div>
