          ...
          <div class="panel-body">
            <form action="my" method="post" class="form-horizontal text-left" role="form">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input class="form-control" type="text" name="username"  value="${my.username}" readonly="readonly"  />
                </div>
              </div>
               ...
               <div class="form-group ${username!=null?'has-error':''}">
                 ...
                 <div class="col-sm-6">
                    <input class="form-control" autocomplete="off" name="username" type="text" value="${my.username}" />
