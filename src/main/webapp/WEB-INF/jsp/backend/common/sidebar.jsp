...
<ul class="side-menu">
  <li><a class="nav-header" href="#">
    ...
    <ul class="sub-menu" style="display: block;">
      ...
      <li><a href="${g.domain}/backend/option/general">常规选项</a></li>
      <li><a href="${g.domain}/backend/option/post">撰写/阅读</a></li>
      <li><a class="last" href="${g.domain}/backend/option/email">邮件评论</a></li>
    </ul>
   </li>
   ...
   <li><a class="nav-header" href="#">
     ...
     <ul class="sub-menu">
      ...
      <li><a class="last" href="${g.domain}/backend/channels">文章分类</a></li>
    </ul>
  </li>
  <li><a class="nav-header" href="#">
