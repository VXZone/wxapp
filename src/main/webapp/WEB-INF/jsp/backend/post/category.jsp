  ...
  <div class="container-fluid">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
             <div class="btn-group" style="margin-bottom: 10px;">
               ...
               <button type="button" class="btn btn-default" onclick="zblog.channel.remove();">
                 <span class="icon glyphicon glyphicon-minus" aria-hidden="true"></span>删除
               </button>
               <button type="button" class="btn btn-default" onclick="zblog.channel.edit();">
   ...
   <div id="insert-box" class="zdialog">
     ...
     <div class="zcontent clearfix">
       ...
       <input class="form-control" type="text" id="newChannel" style="width: 230px;"  />
     </div>
     <div class="zfooter">
       <button type="button" class="btn btn-default">取消</button>
        <button type="button" class="btn btn-primary" onclick="zblog.channel.insert();">确定</button>
     </div>
   </div>
  
  <script type="text/javascript" src="${g.domain}/resource/bootstrap-tree/bootstrap-treeview.min.js"></script>
  <script type="text/javascript" src="${g.domain}/resource/js/backend/admin.channel.js"></script>
