        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form action="post" method="post" class="form-horizontal text-left" role="form">
              ...
              <div class="form-group ${defaultChannel!=null?'has-error':''}">
                <label class="col-sm-3" for="defaultType">*默认文章分类目录</label>
                <div class="col-sm-6">
                  <select class="form-control" name="defaultChannel">
                    <c:if test="${form.defaultChannel==null}">
                       <option>请选择</option>
                    </c:if>
                   <c:forEach var="channel" items="${channels}" begin="1">
                     <option value="${channel.id}" ${form.defaultChannel==channel.id?'selected':''} >
