...
<body>
  ...
  <div id="content" class="clearfix">
    <div id="left_col" class="clearfix">
     <c:if test="${channel!=null||tag!=null||archive!=null||search!=null}">
       <div id="archive_headline"><h2>
        <c:choose>
          <c:when test="${channel!=null}">'<span>${channel}</span>' 目录归档</c:when>
      ...
      <div class="post_wrap clearfix">
        ...
        <div class="meta">
          <ul>
            ...
            <li class="post_read">${post.viewCount}人阅读</li>
            <li class="post_author">
              <a rel="author" title="由${post.user.username}发布" href="${g.domain}/authors/${post.creator}">${post.user.username}</a>
            </li>
            <li class="post_comment">
               <a title="${post.title}的评论" href="${g.domain}/posts/${post.id}/#respond">
                 <c:choose>
                   <c:when test="${post.commentCount>0}">${post.commentCount}条评论</c:when>
