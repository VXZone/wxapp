...
public class MetaWeblogController{
  ...
  public void wlwmanifest(HttpServletResponse response){
    ...
    xml.append("<option><clientType>Metaweblog</clientType><supportsKeywords>Yes</supportsKeywords><supportsNewCategories>Yes</supportsNewCategories><supportsSlug>Yes</supportsSlug><supportsAuthor>Yes</supportsAuthor><supportsGetTags>Yes</supportsGetTags></option>");
    xml.append("<weblog>\n");
    xml.append("<serviceName>Zblog</serviceName>\n");
    xml.append("<homepageLinkText>" + optionService.getOptionValue(OptionConstants.TITLE) + "</homepageLinkText>\n");
